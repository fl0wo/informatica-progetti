...
public class Piramide {
    ...
    Poligono[] Polys = new Poligono[5];
    double[] angle;

    public Piramide(double x, double y, double z, double width, double length, double height, Color c) {
        Polys[0] = new Poligono(new double[]{x, x + width, x + width, x}, new double[]{y, y, y + length, y + length}, new double[]{z, z, z, z}, c, false);
        Schermo.poligoni3d.add(Polys[0]);
        Polys[1] = new Poligono(new double[]{x, x, x + width}, new double[]{y, y, y, y}, new double[]{z, z + height, z + height}, c, false);
        Schermo.poligoni3d.add(Polys[1]);
        Polys[2] = new Poligono(new double[]{x + width, x + width, x + width}, new double[]{y, y, y + length}, new double[]{z, z + height, z + height}, c, false);
        Schermo.poligoni3d.add(Polys[2]);
        Polys[3] = new Poligono(new double[]{x, x, x + width}, new double[]{y + length, y + length, y + length}, new double[]{z, z + height, z + height}, c, false);
        Schermo.poligoni3d.add(Polys[3]);
        Polys[4] = new Poligono(new double[]{x, x, x}, new double[]{y, y, y + length}, new double[]{z, z + height, z + height}, c, false);
        Schermo.poligoni3d.add(Polys[4]);
...
/////////
    ...
    void updatePoly() {
        for (int i = 0; i < 5; i++) {
            Schermo.poligoni3d.add(Polys[i]);
            Schermo.poligoni3d.remove(Polys[i]);
        }
